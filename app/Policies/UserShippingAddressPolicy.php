...
class UserShippingAddressPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\UserShippingAddress  $userShippingAddress
     * @return mixed
     */
     ...
     * @return mixed
     */
    public function restore(User $user, UserShippingAddress $userShippingAddress)
    {
        return $user->id === $userShippingAddress->user_id;  
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, UserShippingAddress $userShippingAddress)
    {
        return $user->id === $userShippingAddress->user_id;  
    }
}
